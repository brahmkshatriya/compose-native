 ...
 */
@Immutable
class FontResource @InternalResourceApi constructor(id: String, items: Set<ResourceItem>) :
    Resource(id, items)
 ...
 * @param weight The weight of the font. Default value is [FontWeight.Normal].
 * @param style The style of the font. Default value is [FontStyle.Normal].
 * @param variationSettings Custom variation settings for the font, with a default value derived
 *   from the specified [weight] and [style].
 * @return The created [Font] object.
 * @throws NotFoundException if the specified resource ID is not found.
 */
@Composable
