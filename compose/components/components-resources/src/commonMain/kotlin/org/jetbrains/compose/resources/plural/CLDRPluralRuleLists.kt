...
/**
 * THIS CODE IS AUTOGENERATED BY './gradlew :resources:library:generatePluralRuleLists' DO NOT
 * EDIT!!!
 */
internal val cldrPluralRuleListIndexByLocale =
    mapOf(
        "bm" to 0,
        "bo" to 0,
        "dz" to 0,
...
internal val cldrPluralRuleLists =
    arrayOf(
        arrayOf(PluralCategory.OTHER to ""),
        arrayOf(PluralCategory.ONE to "i = 0 or n = 1", PluralCategory.OTHER to ""),
        arrayOf(PluralCategory.ONE to "i = 0,1", PluralCategory.OTHER to ""),
        arrayOf(PluralCategory.ONE to "i = 1 and v = 0", PluralCategory.OTHER to ""),
        arrayOf(PluralCategory.ONE to "n = 0,1 or i = 0 and f = 1", PluralCategory.OTHER to ""),
        arrayOf(PluralCategory.ONE to "n = 0..1", PluralCategory.OTHER to ""),
        arrayOf(PluralCategory.ONE to "n = 0..1 or n = 11..99", PluralCategory.OTHER to ""),
        arrayOf(PluralCategory.ONE to "n = 1", PluralCategory.OTHER to ""),
        arrayOf(PluralCategory.ONE to "n = 1 or t != 0 and i = 0,1", PluralCategory.OTHER to ""),
        arrayOf(
            PluralCategory.ONE to
