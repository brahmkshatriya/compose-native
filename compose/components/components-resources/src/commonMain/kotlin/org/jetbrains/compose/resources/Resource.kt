...
@InternalResourceApi
constructor(internal val id: String, internal val items: Set<ResourceItem>) {
 ...
 * @property offset The offset in bytes of the resource in the file. '-1' means the resource is
 *   whole file
 * @property size The size in bytes of the resource in the file. '-1' means the resource is whole
 *   file
 */
@InternalResourceApi
@Immutable
