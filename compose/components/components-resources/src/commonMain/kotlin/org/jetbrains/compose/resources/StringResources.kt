...
fun stringResource(resource: StringResource): String {
    ...
    val str by
        rememberResourceState(resource, { "" }) { env -> loadString(resource, resourceReader, env) }
    return str
}
...
fun stringResource(resource: StringResource, vararg formatArgs: Any): String {
    ...
    val str by
        rememberResourceState(resource, args, { "" }) { env ->
...
suspend fun getString(
    ...
    loadString(resource, formatArgs.map { it.toString() }, DefaultResourceReader, environment)
