 ...
 * [WindowsNativeAccessibility.perform].
 */
...
): NativeAccessibility = WindowsNativeAccessibility(dispatchAction)

internal class WindowsNativeAccessibility(private val dispatchAction: (() -> Unit) -> Unit) :
    NativeAccessibility {
