...
import nativedesktop.kld_atspi_is_connected
import nativedesktop.kld_atspi_window_add_action
import nativedesktop.kld_atspi_window_add_node
import nativedesktop.kld_atspi_window_begin_update
import nativedesktop.kld_atspi_window_commit_update
import nativedesktop.kld_atspi_window_create
import nativedesktop.kld_atspi_window_destroy
import nativedesktop.kld_atspi_window_set_collection
import nativedesktop.kld_atspi_window_set_editable_actions
import nativedesktop.kld_atspi_window_set_value
...
): NativeAccessibility = LinuxAtSpiAccessibility(dispatchAction)
...
internal class LinuxAtSpiAccessibility(
    ...
    override fun refreshAfterLayout() {
        if (!refreshAfterLayout && !rebuildPending) return
        refreshAfterLayout = false
        rebuild()
    }

    override fun onAccessibilityBusConnected() {
