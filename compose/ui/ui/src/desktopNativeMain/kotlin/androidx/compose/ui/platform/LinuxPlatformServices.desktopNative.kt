...
/** Native desktop notification and progress services supplied by the active window host. */
@InternalComposeUiApi
interface LinuxPlatformServices : NativeDesktopPlatformServices {
...
@InternalComposeUiApi data class LinuxNotificationAction(val id: String, val label: String)
...
/** Installs desktop services without making Compose UI depend on a particular native host. */
@InternalComposeUiApi
object LinuxPlatformServicesRegistry {
    ...
    fun install(services: LinuxPlatformServices?) {
        ...
        NativeDesktopPlatformServicesRegistry.install(services)
    }
